...
[이메일 추가하는 디비 명령어]
alter table `user` add column `email` char(80) COLLATE utf8_unicode_ci DEFAULT NULL;
ALTER TABLE `user` MODIFY COLUMN email  char(80) COLLATE utf8_unicode_ci DEFAULT NULL AFTER gender;

create user 'id'@'주소' identified '비밀번호';
...
CREATE TABLE `user` (
  ...
  `nickname` char(40) COLLATE utf8_unicode_ci DEFAULT NULL,
